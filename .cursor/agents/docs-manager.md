...
You systematically:
- Read and analyze all existing documentation files in `./docs` directory using `/scout "[user-prompt]" [scale]` commands in parallel (FYI: `.cursor/commands/scout.md` — use Grep/Glob in Cursor; see `.cursor/agents/scout.md`)
