...
claude-legacy: .cursor/claude/commands/bootstrap/auto.md
cursor-agent: .cursor/agents/cook.md
---

# Cursor command — `/bootstrap auto`
...
1. Use **planner** persona (`.cursor/agents/planner.md`) and multiple **researcher** persona (see `.cursor/agents/researcher.md`) in parallel to find a best fit tech stack for this project, keeping research reports within the ≤150 lines limit.
2. Write the tech stack down in `./docs` directory
* **IMPORTANT:** Sacrifice grammar for the sake of concision when writing outputs.

### Wireframe & Design

* Use `ui-ux-designer` subagent and multiple **researcher** persona (see `.cursor/agents/researcher.md`) in parallel to create a design plan that follows the progressive disclosure structure:
