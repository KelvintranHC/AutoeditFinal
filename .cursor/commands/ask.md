...
claude-legacy: .cursor/claude/commands/ask.md
cursor-agent: .cursor/agents/architect.md
---
...
- **Primary persona:** Open and follow `.cursor/agents/architect.md` for this command.
...
- Primary workflow: `./.cursor/workflows/primary-workflow.md`
- Development rules: `./.cursor/workflows/development-rules.md`
- Orchestration protocols: `./.cursor/workflows/orchestration-protocol.md`
- Documentation management: `./.cursor/workflows/documentation-management.md`
...
1. **Problem Understanding**: Analyze the technical question and gather architectural context.
   - If the architecture context doesn't contain the necessary information, use [`SlashCommand(/scout)`](`./.cursor/commands/scout.md`) to scout the codebase again.
