...
argument-hint: "[task]"
claude-legacy: .cursor/claude/commands/plan/hard.md
cursor-agent: .cursor/agents/planner.md
---

# Cursor command — `/plan hard`
...
5. Main agent gathers all research and scout report filepaths, and pass them to **planner** persona (`.cursor/agents/planner.md`) with the prompt to create an implementation plan of this task.
6. Main agent receives the implementation plan from **planner** persona (`.cursor/agents/planner.md`), and ask user to review the plan
