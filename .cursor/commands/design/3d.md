...
argument-hint: "[tasks]"
claude-legacy: .cursor/claude/commands/design/3d.md
cursor-agent: .cursor/agents/ui-ux-designer.md
---

# Cursor command — `/design 3d`
...
## Workflow:
1. Use `ui-ux-designer` subagent and **researcher** persona (`.cursor/agents/researcher.md`) to create a comprehensive 3D design plan following the progressive disclosure structure:
