...
claude-legacy: .cursor/claude/commands/brainstorm.md
cursor-agent: .cursor/agents/brainstormer.md
---

# Cursor command — `/brainstorm`

## Cursor parity (no Task spawn)

- **Primary persona:** Open and follow `.cursor/agents/brainstormer.md` for this command.
