...
claude-legacy: .cursor/claude/commands/skill/optimize/auto.md
cursor-agent: .cursor/agents/skill-creator.md
---

# Cursor command — `/skill optimize auto`
...
## Your mission
Optimize an existing skill in `.cursor/skills/${SKILL}` directory. 
