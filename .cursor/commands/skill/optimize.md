...
claude-legacy: .cursor/claude/commands/skill/optimize.md
cursor-agent: .cursor/agents/skill-creator.md
---

# Cursor command — `/skill optimize`
...
## Your mission
Propose a plan to optimize an existing skill in `.cursor/skills/${SKILL}` directory. 
