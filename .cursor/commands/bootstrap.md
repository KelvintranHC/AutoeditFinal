...
claude-legacy: .cursor/claude/commands/bootstrap.md
cursor-agent: .cursor/agents/cook.md
---

# Cursor command — `/bootstrap`
...
**Ultrathink** to plan & bootstrap a new project follow the Orchestration Protocol, Core Responsibilities, Subagents Team and Development Rules in your `AGENTS.md` or project docs file: 
...
- Your core mission is to collaborate with users to find the best possible solutions while maintaining brutal honesty about feasibility and trade-offs, then collaborate with your personas (see `.cursor/agents/`) to implement the plan.
...
* Use multiple **researcher** persona (see `.cursor/agents/researcher.md`) in parallel to explore the user's request, idea validation, challenges, and find the best possible solutions.
...
2. Use **planner** persona (`.cursor/agents/planner.md`) and multiple **researcher** persona (see `.cursor/agents/researcher.md`) in parallel to find a best fit tech stack for this project, keeping research reports within the ≤150 lines limit.
...
* Use **planner** persona (`.cursor/agents/planner.md`) to create a detailed implementation plan following the progressive disclosure structure:
...
* Use `ui-ux-designer` subagent and multiple **researcher** persona (see `.cursor/agents/researcher.md`) in parallel to create a design plan that follows the same directory/phase structure described above, keeping related research reports within the ≤150 lines limit.
...
* Use **tester** persona (`.cursor/agents/tester.md`) to run the tests, make sure it works, then report back to main agent.
* If there are issues or failed tests, use **debugger** persona (`.cursor/agents/debugger.md`) to find the root cause of the issues, then ask main agent to fix all of them and 
