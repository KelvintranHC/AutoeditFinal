...
argument-hint: "[plan]"
claude-legacy: .cursor/claude/commands/code.md
cursor-agent: .cursor/agents/implement-from-plan.md
---
...
- **Primary persona:** Open and follow `.cursor/agents/implement-from-plan.md` for this command.
...
**IMPORTANT:** Remind these rules with personas (see `.cursor/agents/`) communication:
