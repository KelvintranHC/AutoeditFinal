...
claude-legacy: .cursor/claude/commands/fix/hard.md
cursor-agent: .cursor/agents/debugger.md
---

# Cursor command — `/fix hard`
...
1. Use **debugger** persona (`.cursor/agents/debugger.md`) to find the root cause of the issues and report back to main agent.
2. Use **researcher** persona (`.cursor/agents/researcher.md`) to research quickly about the root causes on the internet (if needed) and report back to main agent.
...
5. Use **tester** persona (`.cursor/agents/tester.md`) to write test cases and run the tests, make sure it works, then report back to main agent.
6. If there are issues or failed tests, use **debugger** persona (`.cursor/agents/debugger.md`) to find the root cause of the issues, then ask main agent to fix all of them.
