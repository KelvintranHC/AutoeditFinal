...
argument-hint: "[tasks]"
claude-legacy: .cursor/claude/commands/integrate/sepay.md
cursor-agent: .cursor/agents/cook.md
---

# Cursor command — `/integrate sepay`
...
- **Scout**: Use **scout** persona (`.cursor/agents/scout.md`) to find related resources, documents, and code snippets in the current codebase.
- **Plan**: Trigger slash command `/plan:fast <detailed-instruction-prompt>` to create an implementation plan based on the reports from **scout** persona (`.cursor/agents/scout.md`).
